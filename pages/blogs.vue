<template>
  <div className="max-w-6xl mx-auto">
    <div
      className="relative min-h-[40vh] flex items-center justify-end flex-col"
    >
      <h2 className="text-center text-4xl font-header">
        <span>Blogs</span>
      </h2>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-24 mt-24">
      <NuxtLink
        v-for="blog in blogs"
